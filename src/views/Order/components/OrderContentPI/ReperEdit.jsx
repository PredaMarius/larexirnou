  ...
  //-------------------------------------------------------------------------------------------------------------------
    onChangeTipSubprodus= (e)=>{ 
      ...
      if ([5,6,7].includes(value)){ // plisse 5 6 7
        setCurrentItem({...currentItem, [key]: value, [key2]:value2, culoareCaseta:0,denumireCuloareCaseta:'', optional1:0, denumireOptional1:'', tipActionare:1, denumireTipActionare:'FINALA'})
      }else{
        setCurrentItem({...currentItem, [key]: value, [key2]:value2, culoareCaseta:0,denumireCuloareCaseta:'', optional1:0, denumireOptional1:'', tipActionare:0, denumireTipActionare:''})
      }
    ...
    calculPretCatalog= async()=>{      
      ...
      const pretCatalog=pretPi(this.produse, currentItem.tipSubprodus, currentItem.lungime, currentItem.inaltime, currentItem.culoareCaseta, currentItem.optional1, this.preturitabelare, currentItem.buc).toFixed(2);
            ...
            >
              ...
              <CardContent style={{overflow:'scroll', maxHeight:'350px'}} >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0]?
                        this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].culoriCompatibile[0]?
                  ...
                  >
                    <TextField
                      error={errors.m3m.mesaj || errors.m4m.mesaj || errors.m5m.mesaj? true:false}
                      fullWidth
                      helperText={errors.m3m.mesaj || errors.m4m.mesaj || errors.m5m.mesaj ? (errors.m3m.mesaj? errors.m3m.mesaj + ' ':'')+ (errors.m4m.mesaj? errors.m4m.mesaj + ' ':'')+ + (errors.m5m.mesaj? errors.m5m.mesaj + ' ':''):''}
                      InputLabelProps={{shrink:true}}
                  ...
                  >
                    <TextField
                      disabled={this.handleCotaEnabled()}
                      fullWidth
                      InputLabelProps={{shrink:true}}
                      label="Cota"
                      margin="dense"
                  ...
                  >
                    ...
                    >
                      ...
                      {this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)?
                        this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0]?
                          this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].optionaleCompatibile.filter(optional=>optional.activ.toUpperCase()!=='NU')[0]?
                            this.produse.filter(produs=>produs.activ.toUpperCase()!=='NU' && produs.key===currentItem.tipSubprodus)[0].optionaleCompatibile.filter(optional=>optional.activ.toUpperCase()!=='NU').sort(dynamicSort('denumire')).map(option => (
                              <option
                                key={option.key}
                                value={option.denumire}
                              >
                  ...
                  >
                    ...
                    >
                      <TextField
                        ...
                        fullWidth
                        helperText={errors.m2m.mesaj ? (errors.m2m.mesaj? errors.m2m.mesaj + ' ':''):''}
                        InputLabelProps={{shrink:true}}
                        inputProps={{style: { textAlign: 'right' }}}
                        InputProps={{
