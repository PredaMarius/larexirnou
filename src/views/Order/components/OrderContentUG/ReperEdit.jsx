...
class ReperEdit extends React.Component {
  ...
  //-------------------------------------------------------------------------------------------------------------------
    ...
    calculPretCatalog= async()=>{      
      ...
      const pretCatalog=pretUg(this.produse, currentItem.tipSubprodus, currentItem.lungime, currentItem.inaltime, currentItem.culoareLamela, currentItem.culoareCaseta,currentItem.tipActionare, currentItem.optional1, currentItem.optional2, currentItem.optional3,this.preturitabelare, currentItem.buc).toFixed(2);
             ...
             >
               ...
               <CardContent style={{overflow:'scroll', maxHeight:'350px'}} >
                 ...
                 >
                   ...
                   >
                     <TextField
                       error={errors.m4m.mesaj ? true:false}
                       fullWidth
                       helperText={errors.m4m.mesaj ? (errors.m4m.mesaj? errors.m4m.mesaj + ' ':''):''}
                       InputLabelProps={{shrink:true}}
                   ...
                   >
                     ...
                     >
                       <TextField
                         error={errors.m2m.mesaj || errors.m3m.mesaj ?true:false}
                         fullWidth
                         helperText={errors.m2m.mesaj || errors.m3m.mesaj ? (errors.m2m.mesaj? errors.m2m.mesaj + ' ':'')+(errors.m3m.mesaj? errors.m3m.mesaj + ' ':''):''}
                         InputLabelProps={{shrink:true}}
                         inputProps={{style: { textAlign: 'right' }}}
                         InputProps={{
