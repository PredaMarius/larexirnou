...
class OrderContentRO extends React.Component{
  ...
  //...........................<specific moneda>
  footerTotal=(props)=>{
    return (<span><strong>{props.Sum.toFixed(2)} Lei</strong></span>)
  }
  //----------------------------------------------------------------------------------------------------
  footerTotalMp=(props)=>{
  ...
  return (
    <Card className="control-panel">
      <div className="control-section">
        ...
        >
          <ColumnsDirective>
            ...
            <ColumnDirective
              field="inaltime"
              format="N"
              headerText="INALTIME PANZA"
              textAlign="Center"
              width="90"
            />
            <ColumnDirective
              field="inaltimeFinala"
              format="N"
              headerText="INALTIME FINALA"
              textAlign="Center"
              width="90"
            />
            <ColumnDirective
            ...
            />
            <ColumnDirective
              field="culoareComponente"
              headerText="CULOARE COMP. VECHI *)"
              textAlign="Center"
              width="90"
            />
            <ColumnDirective
              field="denumireCuloareLamela"
              headerText="CULOARE COMP."
              textAlign="Center"
              width="90"
            />
        ...
        <p> *)rubrica CULOARE COMP. VECHI nu se mai foloseste, s-a adaugat o rubrica noua cu selectie dintr-o lista de culori prestabilita ce va influenta pretul.(ex. ANTRACIT +5%)</p>
      </div>
      <ReperEdit
